...
public class A04_Amp_PreloadTwoFront extends BaseRoutine {
    ...
    public A04_Amp_PreloadTwoFront() {
        driveToFirstNote = Choreo.getTrajectory("Amp_PreloadTwoFront.1");
        driveToSecondNote = Choreo.getTrajectory("Amp_PreloadTwoFront.2");
