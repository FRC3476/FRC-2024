...
/**
 * A utility class for interfacing with the Limelight NetworkTables API.
 *
 * @author Limelight
 */
public class LimelightHelpers {
    ...
    //public static double getTS(String limelightName) { return getLimelightNTDouble(limelightName, "ts"); }
