...
public class BlinkinLEDController extends AbstractSubsystem {
    ...
    private static final HashMap<Alliance, BlinkinPattern[]> m_allianceColors = new HashMap<Alliance, BlinkinPattern[]>();
    ...
    public BlinkinLEDController() {
        m_blinkin = new Spark(Constants.Ports.BLINKIN_LED_CONTROLLER);
